...
@app.get("/character/{char_id}", dependencies=[Depends(verify_api_key)])
...
@app.get("/freecompany/{fc_id}", dependencies=[Depends(verify_api_key)])
...
@app.get("/search/character/{character_name}/server/{server_name}", dependencies=[Depends(verify_api_key)])
